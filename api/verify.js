...
// namespace جديد كلياً - لازم يكون نفس القيمة بالظبط في trial.js و
// check-status.js.
const APP_NAME = 'payroll_b5otbv_v1';

// مفتاح تفعيل جديد كلياً (مختلف عن أي مفتاح قديم كان موجود). لو عايز
// تضيف مفاتيح تانية لعملاء مختلفين، زوّد سطر جديد في المصفوفة دي.
const VALID_KEYS = ["6HU-OC8R-0D7PQ-R"];
