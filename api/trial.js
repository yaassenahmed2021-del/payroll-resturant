...
// namespace جديد كلياً - لازم يكون نفس القيمة بالظبط في check-status.js
// و verify.js، ومختلف عن أي نسخة سابقة عشان مفيش أي تعارض مع بيانات
// تجارب/تفعيلات قديمة كانت مخزنة تحت اسم مختلف.
